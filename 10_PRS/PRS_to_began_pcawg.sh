...
bcftools view -v snps -O z -o chr$SLURM_ARRAY_TASK_ID.snps.vcf.gz /n/data1/hms/dbmi/zaklab/csy/PCAWG_chr_split/impute_input/${SLURM_ARRAY_TASK_ID}.vcf.gz
...
# vcf to bgen
/n/data1/hms/dbmi/zaklab/csy/PRS/NPS/qctools/qctool -g chr$SLURM_ARRAY_TASK_ID.snps.biallelic.unphased.vcf.gz -og chrom$SLURM_ARRAY_TASK_ID.neer.bgen -os chrom$SLURM_ARRAY_TASK_ID.neer.sample -vcf-genotype-field GT
